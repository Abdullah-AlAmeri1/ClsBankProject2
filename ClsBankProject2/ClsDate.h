...
public:
	...
	{
		vector <string> vDate = Cls_String_Library::Split(DateString, "/");
	...
	static string FormatDate(clsDate Date, string DateFormat = "dd/mm/yyyy")
	{
		...
		FormattedDateString = Cls_String_Library::ReplaceWord(DateFormat, "dd", to_string(Date._Day));
		FormattedDateString = Cls_String_Library::ReplaceWord(FormattedDateString, "mm", to_string(Date._Month));
		FormattedDateString = Cls_String_Library::ReplaceWord(FormattedDateString, "yyyy", to_string(Date._Year));
