...
private:
	...
	static UserSys _ConvertLineToUserObj(string line) {
		...
		return UserSys(_Mod::EnUpdateMod, list[0], list[1], list[2], list[3], list[4], list[5], list[6]);
	...
	static string _ConvertToLine(UserSys obj) {
		string line = obj.FirstName() + "/##/" + obj.LastName() + "/##/" + obj.Email() + "/##/" + obj.Phone + "/##/" + obj._UserName + "/##/" + obj._Password + "/##/" + obj._Permission;
		return line;
	}
