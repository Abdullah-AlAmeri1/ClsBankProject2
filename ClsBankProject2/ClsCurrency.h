...
private:
    ...
    static clsCurrency _ConvertLinetoCurrencyObject(string Line, string Seperator = "#//#")
    {
        ...
        vCurrencyData = Cls_String_Library::Split(Line, Seperator);
...
public:
    ...
    static   clsCurrency FindByCode(string CurrencyCode)
    {
        ...
        CurrencyCode = Cls_String_Library::UpperAllString(CurrencyCode);
    ...
    {
        Country = Cls_String_Library::UpperAllString(Country);
        ...
        if (MyFile.is_open())
        {
            ...
            {
                clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
                if (Cls_String_Library::UpperAllString(Currency.Country()) == Country)
                {
                    MyFile.close();
                    return Currency;
                }
